...
data class NotebookInfo(val id: Long, val owner: String, val title: String)
...
interface NotebookManager {
    ...
    fun userNotebooks(owner: String): List<NotebookInfo>
    fun readNotebook(owner: String, id: Long): Notebook
}
